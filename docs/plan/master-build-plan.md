...
- [ ] HITL overrides persisted to Postgres (table landed in `0005`; adapter pending — Phase 7)
- [~] Audit chain persistence to Postgres (DB-backed chain done in migration `0005` + `DbAuditChain`; verification job pending)
